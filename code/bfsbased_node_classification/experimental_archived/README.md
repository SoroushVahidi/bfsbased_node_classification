...
**For the canonical evidence package, use:**

| Purpose | Script |
|--------|--------|
| FINAL_V3 + baselines / ablations (same splits as `reports/final_method_v3_results.csv`) | `../run_final_evaluation.py` |
| Broader resubmission grid (GCN, APPNP, structural ablations) | `../resubmission_runner.py` |
...
| `run_prl_validation.py` | Earlier validation harness |
