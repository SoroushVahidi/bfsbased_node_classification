...
- **Chameleon:** FINAL_V3 remains conservative; one split (4) shows a small negative Δ vs MLP. Ten-split means stay near the MLP (see `tables/main_results_selective_correction.md`).

## Figure

Bar summary of harmful-split counts: `figures/safety_comparison.png` (regenerate with `bash scripts/run_all_selective_correction_results.sh`).
