# Fairness / Configuration Report – manuscript_focus_r3
...
- Included datasets executed: ['cora', 'citeseer', 'chameleon', 'texas', 'wisconsin']
- Excluded datasets and reasons:
  - cornell: deferred for this manuscript-focused repeat-stability cycle (neutral-control slots allocated to texas/chameleon)
  - actor: deferred for runtime focus; will move to Wulver if needed
  - squirrel: deferred for runtime feasibility (large graph)
  - pubmed: deferred for runtime feasibility (large graph)
