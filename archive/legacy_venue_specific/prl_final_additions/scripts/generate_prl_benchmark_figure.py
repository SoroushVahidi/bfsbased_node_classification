...
MIRROR_FIG = ROOT / "figures" / "prl_final_additions"
...
def main() -> None:
    ...
    MIRROR_FIG.mkdir(parents=True, exist_ok=True)
    shutil.copy2(OUT / "fig_delta_vs_mlp_bar.pdf", MIRROR_FIG / "fig_delta_vs_mlp_bar.pdf")
    shutil.copy2(OUT / "fig_delta_vs_mlp_bar.png", MIRROR_FIG / "fig_delta_vs_mlp_bar.png")
